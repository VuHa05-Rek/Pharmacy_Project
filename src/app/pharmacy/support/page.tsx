...
export default function Support (){
    ...
    // lưu các pair (question, handler) để cleanup đúng
    const listeners: { question: Element; handler: EventListener }[] = [];


    faqItems.forEach(item => {
      const question = item.querySelector('.question');
      if (!question) return; // tránh lỗi khi question = null
      const handler = () => {
        item.classList.toggle('active');
      };
      question.addEventListener('click', handler);
      listeners.push({ question, handler });
    });

    return () => {
      // cleanup đúng handler tương ứng
      listeners.forEach(({ question, handler }) => {
    ...
    return (
        <div className='container-support'>
            ...
            <div className="content-support">
                ...
                <div className="support-part-3">
                    <h2>III. Direct Support Contact Channel</h2>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>Email</td>
                                <td>support@tenwebsite.com</td>
                                <td>Response within 24 hours</td>
                            </tr>
                            <tr>
                                <td>Hotline</td>
                                <td>1900 xxxx (Free/Chargeable)</td>                                        
                                <td>8:00 - 18:00 (Monday - Friday)</td>
                            </tr>
                            <tr>
                                <td>Live Chat</td>
                                <td>Chat icon in the corner of the screen</td>
                                <td>24/7 (Can be Chat Bot outside of business hours)</td>
                            </tr>
                            <tr>
                                <td>Contact Form</td>
                                <td>Name, Email, Title, Content</td>
                                <td>Use if the customer does not need an immediate response</td>
                            </tr>
                            <tr>
                                <td>Social network</td>
                                <td>Facebook/Zalo/Instagram</td>
                                <td>Quick response during business hours</td>
                            </tr>
                        </tbody>
                    </table>
                    <div className ="note-support">
                        <strong>Advice:</strong> Customers are encouraged to provide Order Code or Account Name when contacting for fastest support.
                    </div>
                </div>
                <div className="support-part-4">
                    <h2>IV. Related Policy Pages</h2>
                    <ul>
                        <li>- <a href="/pharmacy/rules-points">🔗 Membership Points Rules</a></li>
                        <li>- <a href="/pharmacy/introduce">🔗 Introduction to HoangHa Pharmacy</a></li>
                        <li>- <a href="/pharmacy/return-policy">🔗 Return and Warranty Policy</a></li>
                        <li>- <a href="/pharmacy/privacy-policy">🔗 Privacy Policy</a></li>
                    </ul>
                </div>
            </div>
            <Footer />
