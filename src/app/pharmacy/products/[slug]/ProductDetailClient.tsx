      ...
      <div className={styles.container_header}>
        ...
        <div className={styles.infoSection}>
          ...
          <div className={styles.infoCommon}>
            <li className={styles.manufacturer}>
              <strong>Manufacturer: </strong>
              {product.manufacturer}
            </li>
            <li className={styles.placeOfManufacture}>
              <strong>Place Of Manufacture: </strong>
              {product.placeOfManufacture}
            </li>
            <li className={styles.uses}>
              <strong>Uses: </strong>
          ...
          <div className={styles.quantityContainer}>
            ...
            <div className={styles.quantityInput}>
              <button type="button" className={styles.quantityBtn} onClick={handleDecrease}>
                -
              </button>
              <input type="number" className={styles.quantityNumber} value={quantity} readOnly />
              <button type="button" className={styles.quantityBtn} onClick={handleIncrease}>
                +
              </button>
            </div>
          </div>
