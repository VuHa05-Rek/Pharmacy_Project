...
export const products = [
  {
    ...
    ingredients: 'Vitamin C from Ascorbic acid, Sodium ascorbate, Calcium ascorbate, Rutin, Hesperidin, Lemon bioflavonoid complex, Rose Hips extract and Acerola fruit pulp extract',
    outstanding: 'Nat C 1000 nổi bật nhờ hàm lượng cao, công thức ít gây kích ứng dạ dày và khả năng hấp thu tối ưu nhờ việc bổ sung các chất chống oxy hóa tự nhiên. Sự kết hợp các Bioflavonoid không chỉ giúp tăng cường hoạt tính của Vitamin C mà còn hỗ trợ tăng tính bền vững của các mạch máu nhỏ. Sản phẩm được thiết kế đặc biệt cho những người cần bổ sung Vitamin C liều cao thường xuyên mà không muốn gặp phải các vấn đề về tiêu hóa.',
  },
  {
    id: 2,
    ...
    usage: 'Uống 1-2 viên mỗi 4-6 giờ khi cần thiết. Không dùng quá 8 viên trong 24 giờ.',
    ingredients: 'Paracetamol 500mg, Excipients: povidone, croscarmellose sodium, magnesium stearate, microcrystalline cellulose, colloidal silicon dioxide, hypromellose, polyethylene glycol, titanium dioxide, iron oxide yellow, iron oxide red.',
    outstanding: 'Paracetamol 500mg là loại thuốc giảm đau, hạ sốt phổ biến và an toàn nhất ở liều điều trị. Nó được ưu tiên nhờ cơ chế hạ sốt và giảm đau hiệu quả mà không gây hại cho dạ dày như các thuốc kháng viêm khác. Nó có thể được sử dụng rộng rãi, kể cả cho phụ nữ mang thai, cho con bú và trẻ em (theo liều lượng và chỉ định phù hợp). Tuyệt đối không được dùng quá liều vì có nguy cơ gây độc tính nghiêm trọng trên gan.'
  },
  {
    id: 3,
  ...
  },
  {
    ...
    ingredients: 'Fish Oil (providing EPA and DHA), Gelatin, Glycerin, Purified Water, Vitamin E (as d-alpha tocopheryl acetate).',
    outstanding: 'Dầu cá Omega-3 là chất béo thiết yếu, nổi bật với sự hiện diện của EPA và DHA. Nó được coi là một chất bổ sung quan trọng hàng đầu trong việc hỗ trợ sức khỏe tim mạch và phát triển/duy trì chức năng não bộ và mắt. Khi chọn mua, người tiêu dùng thường tìm kiếm sản phẩm có hàm lượng EPA và DHA cao (thường được ghi rõ trên nhãn) và được tinh chế để loại bỏ các kim loại nặng.'
  },
  {
    id: 5,
    slug: 'kem-gluconate',
  ...
  },
  {
    ...
    usage: 'Uống 1 viên mỗi ngày sau bữa ăn',
    ingredients: 'Aspirin 81mg, Excipients: microcrystalline cellulose, croscarmellose sodium, magnesium stearate, silicon dioxide.',
    outstanding: 'Aspirin 81mg là một loại thuốc có vai trò đặc biệt là thuốc chống huyết khối (chống đông máu), được sử dụng trong thời gian dài để dự phòng các biến cố tim mạch. Đây không phải là liều để giảm đau hoặc hạ sốt. Việc sử dụng Aspirin 81mg cần được bác sĩ chỉ định vì nó liên quan đến nguy cơ chảy máu, đặc biệt là ở dạ dày và ruột.'
  }
];
